...
ff = file_len(args.tweet)
print("Positives = ",n1_pos)
print("total nos= ",ff)
print(find_ones(n1_pos))
...
ff = file_len(args.tweet)
print("Positives = ",n2_pos)
print("total nos= ",ff)
print(find_ones(n2_pos))

answer=map(add,n_pos,n1_pos)
answer=map(add,answer,n2_pos)
an=np.asarray(answer)
print(an)
print("Mean=",an.mean())
